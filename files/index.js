...
const UUID = process.env.UUID || '9cf59e6d-9866-4dfa-8554-da2d9218b4fb'; //若需要改UUID，需要在config.json里改为一致
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nezha.xiaopang66.xyz';     
const NEZHA_PORT = process.env.NEZHA_PORT || '443';                     // 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || 'dmHd9pStzrR5gFZi57';
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo329.xiaopang66.net';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiOGI3YTQ4ZTNhNWIwMzc0ZjlkZmVmNDExM2NiMzFjNTkiLCJ0IjoiZjRkZDgzMGUtNWRmNC00ODdjLTk5ZWEtYmRmNzYwYzI0OGRhIiwicyI6Ik9UZGlOMk13TWpJdE5EZzFNeTAwTkdJMExUa3laR1V0WXpWbE5tVXdOMlV4TXpRdyJ9';
